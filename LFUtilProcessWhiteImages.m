...
% - Added Sheila's tests : Processing of mla calibration data and white image metadata to generate grid2.json and gridcent.json alternative calibration files compatible with the decoding pipeline.
